    ...
    return (
      <div className="explore-container" ref={containerRef}>
        ...
        <div className="explore-empty">
          ...
          <div className="explore-empty-visual">
            <div className="explore-empty-book explore-empty-book-1">
            ...
            <div className="explore-empty-book explore-empty-book-2">
            ...
            <div className="explore-empty-book explore-empty-book-3">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" opacity="0.4">
          ...
          <p>
            ...
            Create and publish your own to be the first!
          </p>

          <button
            className="explore-empty-cta"
            onClick={() => navigate('/')}
          >
